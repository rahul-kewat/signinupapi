...
class User extends Authenticatable  implements HasRoleAndPermissionContract{
    ...
    protected $fillable = ['firstname','lastname', 'email', 'password','status','phone_number','phone_country_code','fb_id','google_id','image','social_image','is_notification','gender','blood_group'];
